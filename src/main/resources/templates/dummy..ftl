<div class="generic-container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="formcontainer">
                <img src="images/{{selectedIndex.imageID}}"
                     alt="Wählen Sie ein Container Modul aus..." class="img"/>
            </div>
            <div class="row">
                <div class="form-actions floatRight">
                    <h4>Der Gesamtpreis: {{selectedIndex.preis}} EUR</h4>
                </div>
            </div>
        </div>
        <div class="panel panel-default">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <input class="form-control" type="number" name="anzahl" id="anzahl"
                               min="1" max="500" step="1" value="1" placeholder="Bitte wählen Sie die Anzahl der Module aus" ng-model="theValue">
                    </div>
                </div>
            </div>
    ...
    <div class="panel panel-default">
        <!-- Default panel contents -->
        <div class="panel-heading"><span class="lead">CONFIGURATOR MODULAUSWAHL</span></div>
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-4">
                    <select class="form-control" ng-model="selectedIndex" ng-change="changedValue(selectedIndex)"
            ...
            <div class="row">
                <div class="col-lg-4">
                    <input class="form-control" type="number" name="anzahl" id="anzahl"
                           min="1" max="500" step="1" value="1" placeholder="Bitte wählen Sie die Anzahl der Module aus"
                           ng-model="theValue" onchange="berechne">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-actions floatRight">
                ...
                <button type="submit" ng-click="ctrl.save()"
                        class="btn btn-success custom-width" ui-sref=".nutzungsart">WEITER
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="form-actions floatRight">
                    ...
                    <button type="button" ng-click="ctrl.getAllNutzungsarts()"
                            class="btn btn-success custom-width">WEITER</button>
                </div>
            </div>
        </div>-->
        </div>
